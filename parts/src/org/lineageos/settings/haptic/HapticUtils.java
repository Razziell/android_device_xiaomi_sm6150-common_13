...
public final class HapticUtils {
    ...
    final static String PATH_LEVEL = "/sys/devices/platform/soc/c440000.qcom,spmi/spmi-0/spmi0-01/c440000.qcom,spmi:qcom,pm6150@1:qcom,vibrator@5300/leds/vibrator/vmax_mv";

    final static int MIN_LEVEL = 1504;
    final static int MAX_LEVEL = 3544;
